...
- learn the difference between workflow, agent, and multi-agent
- learn when MCP is a better abstraction than ad hoc tool wiring
- learn why A2A is late-stage complexity
...
- justify or reject a specialist agent split

## Proof

Week 5 is successful if you can explain:

- why orchestration is needed or not needed
- where MCP helps
- why A2A is still mostly design material here
